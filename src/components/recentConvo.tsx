...
export class RecentConvo extends Component<RecentConvoProps, any>{
  ...
  render(): RenderReturnType {
    ...
    return <div onClick={this.triggerChooseRecentConversation} style={{ ...containerStyle, paddingLeft: "1.5em", marginTop: "0.0em", marginBottom: "0.0em", background: (this.props.selected ? Colors.getScheme().backgroundRecentConvoSelected : Colors.getScheme().backgroundRecentConvo) }}>
