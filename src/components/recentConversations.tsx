...
export class RecentConversations extends Component<any, any>{
  ...
  render(): RenderReturnType {
    let recentConvos = [];
    recentConvos.push(<RecentConvo conversationID="convo1" otherPersonIDs={["id1", "id2"]} names={["Jagger", "Phineas"]} lastMessage="Here is the last message" />,
      <RecentConvo conversationID="convo2" otherPersonIDs={["id2", "id1"]} names={["Phineas", "Jagger"]} lastMessage="Here is the last message from the other" />);
